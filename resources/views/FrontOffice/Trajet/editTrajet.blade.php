        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
              ...
              <span><a href="{{ route('showRideByUser', ['id' => auth()->user()->id]) }}">my rides <i class="ion-ios-arrow-forward"></i></a></span>
               <span>Edit ride <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Edit Ride</h1>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="container">
                        <div class="row d-flex contact-info justify-content-center">
                            <div class="col-md-8">
                                ...
                                <form method="post" action="{{ route('editRide', $Trajet->id) }}"
                                    enctype="multipart/form-data" class="bg-light p-5 contact-form">
                                    @csrf
                                    @method('put')
                                    <div>
                                        <x-input-label for="Départ" value="Départ" />
                                        <input id="depart" name="depart" type="text" value="{{ $Trajet->depart }}"class="form-control"  autofocus autocomplete="depart" />
                                    ...
                                    <div>
                                        ...
                                        <input id="destination" name="destination" type="text" value="{{$Trajet->destination}}" class="form-control"  autofocus autocomplete="destination" />
                                    ...
                                    <div>
                                        ...
                                        <input id="date_depart" name="date_depart" type="date" value="{{$Trajet->date_depart}}" class="form-control"  autofocus autocomplete="date_depart" />
                                    ...
                                    <div>
                                        ...
                                        <input id="heure_depart" name="heure_depart" type="time" value="{{$Trajet->heure_depart}}" class="form-control"  autofocus autocomplete="heure_depart" />
                                    ...
                                    <div>
                                        ...
                                        <input id="nombre_places_disponibles" name="nombre_places_disponibles" type="number" value="{{$Trajet->nombre_places_disponibles}}" class="form-control"  autofocus autocomplete="nombre_places_disponibles" />
                                    ...
                                    <div>
                                        ...
                                        <input id="prix_par_passager" name="prix_par_passager" type="number" value="{{$Trajet->prix_par_passager}}" class="form-control"  autofocus autocomplete="prix_par_passager" />
