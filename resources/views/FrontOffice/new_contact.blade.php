              ...
              <div
                ...
                <div class="u-col u-col-100"
                  ...
                  <div style="height: 100%;width: 100% !important;">
                    <div
                      style="box-sizing: border-box; height: 100%; padding: 19px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:361px 10px 10px;font-family:arial,helvetica,sans-serif;"
                              align="left">

                              <h1
                                style="margin: 0px; color: #ffffff; line-height: -70%; text-align: center; word-wrap: break-word; font-family: arial black,AvenirNext-Heavy,avant garde,arial; font-size: 22px; font-weight: 400;">
                                AutoRoad</h1>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div
                                style="font-size: 14px; color: #575a5a; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%;">
                                <p>Un nouveau contact a été ajouté à votre application :</p>

                                <p><strong>Nom :</strong> {{ $contact->name }}</p>
                                <p><strong>E-mail :</strong> {{ $contact->email }}</p>
                                <p><strong>Sujet :</strong> {{ $contact->subject }}</p>
                                <p><strong>Catégorie :</strong> {{ $contact->risques->categorie }}</p>
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://facebook.com/" title="Facebook" target="_blank">
                                            <img
                                              src="https://p7.hiclipart.com/preview/201/692/981/logo-facebook-black-and-white-computer-icons-facebook.jpg"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://twitter.com/" title="Twitter" target="_blank">
                                            <img
                                              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTR9-FrOIVetkBkIhxhiIDghYmfX8iwCwiumw&usqp=CAU"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://linkedin.com/" title="LinkedIn" target="_blank">
                                            <img
                                              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5FlhA5OnfIu6p3Rb4j7IrfJjJLrBtOVlrCw&usqp=CAU"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href="https://instagram.com/" title="Instagram" target="_blank">
                                            <img
                                              src="https://i.pinimg.com/1200x/41/e4/57/41e457e8599833299d563976b7d3c59a.jpg"
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div
                                ...
                                <p style="line-height: 140%;"><strong>Auto Road</strong><strong
                                    style="font-size: 14px;">  Tunisia,Tunis</strong></p>
                              </div>
