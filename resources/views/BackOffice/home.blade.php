        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">AutoRoad</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item @if(Route::currentRouteName() == 'admin') active @endif">
            ...
            <li class="menu-item @if(Route::currentRouteName() == 'UsersAdmin') active @endif">
              ...
              <li class="menu-item @if(Route::currentRouteName() == 'TrajetsAdmin') active @endif">
                <a href="{{route('TrajetsAdmin')}}" class="menu-link">
            ...
            <li class="menu-item @if(Route::currentRouteName() == 'ContactsAdmin') active @endif">
                <a href="{{route('ContactsAdmin')}}" class="menu-link">
